...
# This is version 0.3 (v.0.3) of the intepolation object (class)
...
F0A = [-0.7226, -0.7317, -0.7392, -0.7453, -0.7503, -0.7544, -0.7580, -0.7610, -0.7637, -0.7661, -0.7684, -0.7705, -0.7725, -0.7743, -0.7758, -0.7769, -0.7775, -0.7775]
...
class BETA:
     ...
     def F0a_function(self,P,F0A,pressure):         
         self.F0a = np.interp(pressure,P,F0A) 
